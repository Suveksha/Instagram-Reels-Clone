      ...
      <AppBar position="fixed" style={{background:"white"}}>
        <Toolbar>
            ...
            <div style={{marginLeft:"5%"}}>
                <img src={insta} onClick={handlebannerClick} style={{width:"20vh"}}></img>
            </div>
          
          
          <Box sx={{ flexGrow: 1 }} />
          <Box sx={{ display: { xs: 'none', md: 'flex' }, color:'black', alignItems:"center", marginRight:"4rem"}}>
            <HomeIcon sx={{marginRight:"1.5rem" , cursor:"pointer"}} onClick={handlebannerClick}/>
            <ExploreIcon sx={{marginRight:"1rem", cursor:"pointer"}}  onClick={handleexplore}/>
            <IconButton
              size="large"
              edge="end"
